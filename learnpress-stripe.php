<?php
/*
Plugin Name: LearnPress - Stripe Advanced Payment
Plugin URI: http://thimpress.com/learnpress
Description: Stripe payment gateway for LearnPress with coupons.
...
define( 'LP_ADDON_STRIPE_ADVANCED_PAYMENT_FILE', __FILE__ );
define( 'LP_ADDON_STRIPE_ADVANCED_PAYMENT_VER', '3.0.0' );
define( 'LP_ADDON_STRIPE_ADVANCED_PAYMENT_REQUIRE_VER', '3.0.0' );

/**
 * Class LP_Addon_Stripe_Payment_Preload
 */
class LP_Addon_Stripe_Advanced_Payment_Preload {
	...
	public function load() {
		LP_Addon::load( 'LP_Addon_Stripe_Advanced_Payment', 'inc/load.php', __FILE__ );
...
new LP_Addon_Stripe_Advanced_Payment_Preload();