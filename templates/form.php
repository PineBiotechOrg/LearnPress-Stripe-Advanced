...
<div id="learn-press-stripe-form">
    <p class="learn-press-form-row" >
        <label><?php echo wp_kses( __( 'Coupon', 'learnpress-stripe' ), array( 'span' => array() ) ); ?></label>
        <input type="text" name="learn-press-stripe[coupon_code]" id="learn-press-stripe-payment-coupon-code"
               value="" placeholder="coupon"/>
        <span class="input-group-btn apply-coupon-input-btn">
            <button type="button" id="learn-press-stripe-payment-coupon-code-btn" class="coupon-code-button button"><?php _e( 'Apply Coupon', 'learnpress-stripe' ); ?></button>
        </span>
    </p>
    <p class="learn-press-form-row">
